...
import com.cangsg.brick.kt.handler.KtValidateListBoundHandler;

@Documented
@Retention(RetentionPolicy.RUNTIME)
@Target({ ElementType.FIELD })
@KtValidateHandler(handleBy = KtValidateListBoundHandler.class)
public @interface KtValidateListBound {
    /**
     * 数组最大数量，默认50
     * 
     * @return 数组最大数量
